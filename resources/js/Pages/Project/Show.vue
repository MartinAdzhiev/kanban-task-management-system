...
function submitMember() {
    router.post(`/projects/${project.value.id}/addMember`, form)
}
</script>
...
<template>
    ...
    <header class="bg-white shadow flex justify-between">
        ...
        <div class="my-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex gap-4">
            <button @click="open=true" class="text-1xl tracking-tight text-gray-900">See members </button>
            ...
            <li v-for="board in boards" :key="board.id" class="flex justify-between gap-x-6 py-5">
                <div class="flex min-w-0 gap-x-4">
                    <div class="min-w-0 flex-auto">
                        <button class="text-sm font-semibold leading-6 text-gray-900">{{ board.name }}</button>
                            ...
                            <DialogPanel class="pointer-events-auto relative w-screen max-w-md">
                                <TransitionChild as="template" enter="ease-in-out duration-500" enter-from="opacity-0"
                                    ...
                                    <div class="absolute left-0 top-0 -ml-8 flex pr-2 pt-4 sm:-ml-10 sm:pr-4">
                                        ...
                                        focus:outline-none focus:ring-2 focus:ring-white" @click="open = false">
                                            Close
